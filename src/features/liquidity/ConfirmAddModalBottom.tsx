    ...
    <div className="p-6 mt-0 -m-6 rounded bg-dark-800">
      ...
      <div className="grid gap-1 pb-6">
        <div className="flex items-center justify-between">
          ...
          <div className="text-sm font-bold justify-center items-center flex right-align pl-1.5 text-high-emphesis">
            <div>{formatNumberScale(parsedAmounts[Field.CURRENCY_A]?.toSignificant(6), false, 4)}</div>
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="text-sm font-bold justify-center items-center flex right-align pl-1.5 text-high-emphesis">
            <div>{formatNumberScale(parsedAmounts[Field.CURRENCY_B]?.toSignificant(6), false, 4)}</div>
