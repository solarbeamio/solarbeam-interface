...
export const ECLIPSE_PROJECTS: ProjectsMap = {
  0: {
    ...
    tokenContract: '0x1e0F2A75Be02c025Bd84177765F89200c04337Da',
    eclipseContract: '0x022Bcb66662Bb3854b6f16bAbD4c13BFa3dB0b08',
    highlights: [
    ...
    ido: [
      ...
      { title: 'Start Block', description: '809480' },
